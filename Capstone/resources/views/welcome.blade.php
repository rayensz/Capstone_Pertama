                ...
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-lg-13">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Negara Tingkat Obesitas Tertinggi Di Dunia</h5>
                                    ...
                                    <script>
                                        document.addEventListener("DOMContentLoaded", () => {
                                            new ApexCharts(document.querySelector("#barChart"), {
                                                series: [{
                                                    data: [61, 55.9, 55.3, 52.9, 51.6, 50, 48.2, 47.3, 46, 45.8]
                                                }],
                                                chart: {
                                                    type: 'bar',
                                                    height: 350
                                                ...
                                                xaxis: {
                                                    categories: ['Nauru', 'Kepulauan Cook', 'Palau', 'Kepulauan Marshall', 'Tuvalu',
                                                        'Niue', 'Tonga',
                                                        'Samoa', 'Kiribati', 'Mikronesia'
                                                    ],
                                                }
                                            }).render();
                                        });
