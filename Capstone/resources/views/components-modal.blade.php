                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Toggle a working modal demo by clicking the button below. It will slide down and fade in
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>When modals become too long for the user’s viewport or device, they scroll independent of
                                the page itself. You can also create a scrollable modal that allows scroll the modal
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Add <code>.modal-dialog-centered</code> to <code>.modal-dialog</code> to vertically
                                center the modal.</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Modals have three optional sizes, available via modifier classes to be placed on a
                                <code>.modal-dialog</code>. These sizes kick in at certain breakpoints to avoid
                                horizontal scrollbars on narrower viewports..</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>For modals that simply appear rather than fade in to view, remove the <code>.fade</code>
                                class from your <code>.modal</code> element </p>
